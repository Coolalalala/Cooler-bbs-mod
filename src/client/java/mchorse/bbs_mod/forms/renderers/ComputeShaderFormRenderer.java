...
public class ComputeShaderFormRenderer extends FormRenderer<ComputeShaderForm> {
    public static final Link ICON_TEXTURE = Link.assets("textures/compute_shader.png");

    public ComputeShaderFormRenderer(ComputeShaderForm form) {
        super(form);
    }
